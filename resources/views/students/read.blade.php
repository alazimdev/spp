                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Username"
                                        required value="{{$student->name}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row push">
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" placeholder="Email"
                                        required value="{{$student->email}}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="phone_number" name="phone_number"
                                        placeholder="Nomor Handphone" min="0" max="9999999999999999" required value="{{$student->phone_number}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row push">
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nisn" name="nisn" placeholder="NISN"
                                        min="0" max="9999999999" required value="{{$student->nisn}}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nis" name="nis"
                                        placeholder="NIS"min="0" max="999999999" required value="{{$student->nis}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row push">
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Nama Lengkap"
                                        required value="{{$student->full_name}}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                        ...
                        <div class="row push">
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control bg-white" id="date_of_birth" name="date_of_birth" required value="{{$student->date_of_birth}}" readonly>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="junior_high_school" name="junior_high_school"
                                        placeholder="Sekolah Asal" required value="{{$student->junior_high_school}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row push">
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <select name="month_entered" id="month_entered" class="form-control" disabled>
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="year_entered" name="year_entered"
                                        placeholder="Tahun Masuk"min="0" max="9999" required value="{{$student->year_entered}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row push">
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <select name="month_end" id="month_end" class="form-control" disabled>
                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="year_end" name="year_end"
                                        placeholder="Tahun Keluar/Tamat"min="0" max="9999" value="{{$student->year_end}}" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row push">
